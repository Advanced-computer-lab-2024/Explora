...
import Viewing from './components/NoUsed.jsx';
import TouristReport2 from './components/Noused2.jsx';
  ...
  return (
    <main>
      ...
      <Toaster position='top-center' toastOptions={{ duration: 2000 }} />
        ...
        <Route path="/sales2" element={<AdvertiserReport />} />
        <Route path="/sellersales" element={<SellerSales/>} />
        <Route path="/anotif" element={<Anotification/>} />
        <Route path="/sellnot" element={<Anotification2/>} />
        <Route path="/viewacttour" element={<TouristReport2/>}/>
