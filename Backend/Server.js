...
const { authenticateUser } = require('./middleware/AuthMiddleware');const bookingRoutes = require('./Routes/booking');
...
app.use('/api/booking', bookingRoutes);app.use('/reviews', reviewRoutes);
